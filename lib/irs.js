	...
	promises.push(retrieveRate(settlement.irs.interestRate1, settlement.irs.payments[settlement.paymentIndex].effectiveDate) // retrieve first interest rate
		.then(function (data) {
			...
			if (settlement.paymentIndex == 0) {
				diff = settlement.irs.payments[settlement.paymentIndex].effectiveDate - irs.settlement.effectiveDate;
			} else {
				diff = settlement.irs.payments[settlement.paymentIndex].effectiveDate - settlement.irs.payments[settlement.paymentIndex - 1].effectiveDate;
			}
